...
Variation.create(name:"Regular stance", variation_type_id:position)
Variation.create(name:"Wide stance", variation_type_id:position)
Variation.create(name:"Close grip", variation_type_id:position)
Variation.create(name:"Regular grip", variation_type_id:position)
Variation.create(name:"Wide grip", variation_type_id:position)
Variation.create(name:"High bar", variation_type_id:position)
Variation.create(name:"Low bar", variation_type_id:position)
Variation.create(name:"Laying", variation_type_id:position)
Variation.create(name:"Seated", variation_type_id:position)
Variation.create(name:"Standing", variation_type_id:position)
